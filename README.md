...
> (structural facts) with LLM-generated judgments.
...
| Detail | Information |
|--------|-------------|
| **Name** | Imbisat Mahmood |
| **Project** | Week 4 — AI-Assisted Website Quality Auditor |
| **Sector** | Education |
| **Concept** | AI-assisted website audit with facts + LLM judgments |
...
2. **Extracts facts** — title, meta description, headings, links, images, load time
3. **Sends facts to an LLM (Groq / Llama)** for AI-generated quality scores and recommendations
4. **Generates a clean report** in CSV + HTML formats — with facts and AI judgments **clearly separated**
...
```bash
git clone https://github.com/Imbisat-Mahmood/education-website-auditor.git
cd education-website-auditor
...
FACTS — objectively measured by the scraper
...
2. Graceful Failure
If a site returns a 403, times out, or gets blocked by Cloudflare, the tool logs
the failure and continues. It never crashes mid-run.

3. Specific Recommendations
The LLM is prompted to produce actionable advice (e.g., "Add a meta description
under 160 chars") rather than vague advice (e.g., "Improve SEO").
...
👤 Author
Imbisat Mahmood — Week 4 AI-Assisted Website Quality Auditor project.
